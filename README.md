...
This branch of the driver just has the GPIO bits nuked out because they were causing issue when multiple instances of the device were used. Just removed the init/deinit calls made the trick in our testing.
